...
public class IntentExtra {
    public static final String CADENZA_DELIVERY_BUNDLE = "cadenza_delivery_data";
    public static final String CADENZA_DELIVERY_STRING = "cadenza_delivery_string";
    public static final String CADENZA_DELIVERY_INT = "cadenza_delivery_int";
